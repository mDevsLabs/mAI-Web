...
**IMPORTANT**: The official documentation website is `https://mAI.com`. When providing documentation links, always use `https://mAI.com/docs/...` format. Never use `lobechat.com` - that domain is incorrect.

Examples of correct documentation URLs:

- `https://mAI.com/docs/self-hosting/migration/v2/auth/nextauth-to-betterauth`
- `https://mAI.com/docs/self-hosting/migration/v2/auth/clerk-to-betterauth`
- `https://mAI.com/docs/self-hosting/auth`
- `https://mAI.com/docs/self-hosting/auth/providers/casdoor`
